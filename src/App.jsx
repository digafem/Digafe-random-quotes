...
function App() {
  ...
  const colors = [
    ...
    '#77B1A9', '#73A857',"#63b598", "#ce7d78", "#ea9e70", 
    "#a48a9e", "#c6e1e8", "#648177" ,"#0d5ac1" , "#f205e6" ,
    "#1c0365" ,"#14a9ad" ,"#4ca2f9" ,"#a4e43f" ,"#d298e2" ,
    "#6119d0", "#d2737d" ,"#c0a43c" ,"#f2510e" ,"#651be6" ,
    "#79806e" ,"#61da5e" ,"#cd2f00" , "#9348af" ,"#01ac53" ,
    "#c5a4fb" ,"#996635","#b11573" ,"#4bb473" ,"#75d89e" , "#2f3f94" ,
  ...
  const cleanAuthor = (author) => {
    return author ? author.replace(", type.fit", "") : "Unknown";
  };
   

  return (
    
   <div style={{ backgroundColor: color, minHeight: '100vh', minWidth: '100vh' }} >
   <div className='container  pt-5'>
        
      <div id="quote-box">
        <p id="text" style={{ color: color}}>&quot;{randomQuote.text}&quot;</p>
        <h5 id="author" style={{ color: color}}>- {cleanAuthor(randomQuote.author)}</h5>
        <a
       
          id="tweet-quote"
          href={`https://twitter.com/intent/tweet?hashtags=quotes&related=freecodecamp&text=${encodeURIComponent('"' + randomQuote.text + '" - ' + cleanAuthor(randomQuote.author))}`}
          target="_blank"
        ...
        <a
          ...
          id="tumblr-quote"
          href={`https://www.tumblr.com/widgets/share/tool?posttype=quote&tags=quotes,freecodecamp&caption=${encodeURIComponent('"' + randomQuote.text + '" - ' + cleanAuthor(randomQuote.author))}`}
          target="_blank"
          rel="noopener noreferrer"
        >
